...
public class TransactionChainReceiveVO implements Serializable {
    ...
    public TransactionChainReceiveVO(String previous, String blockService, String blockType,
                                     String blockTxType, String sourceTxhash, String amount, String representative, String wallet, String work,
                                     String date) {
        super();
